...
const INITIAL_STAKE_MULTIPLE = new BN(10).pow(new BN(6)); // 100 TSD -> 100M TSDS
...
describe('Pool', function () {
  ...
  beforeEach(async function () {
    ...
    this.dollar = await MockToken.new("Dynamic Set Dollar", "TSD", 18, {from: ownerAddress, gas: 8000000});
